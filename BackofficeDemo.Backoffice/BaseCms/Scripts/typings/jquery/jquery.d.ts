...
interface JQueryEventObject extends  JQueryPopStateEventObject{
}
...
interface JQuery {
    ...
    **********/
    ...
    jqGrid(): JQuery;
    setGridParam(options: any): JQuery;
    modal(): any;
...
interface Blackout{
    ...
    alert(text: string, caption?: string): void;
}

declare var jQuery: JQueryStatic;
declare var $: JQueryStatic;

declare var blackout: Blackout;