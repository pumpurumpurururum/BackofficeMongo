...
{
    public class Error500ViewResult: ViewResult
    {
        public Error500ViewResult()
        {
            this.ViewName = "Http500";
        ...
        {
            return request.AppRelativeCurrentExecutionFilePath == "~/Error/Http500"
